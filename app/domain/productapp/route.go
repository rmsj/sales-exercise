...
func Routes(app *web.App, cfg Config) {
	...
	app.HandlerFunc(http.MethodPut, version, "/products/{product_id}", api.update, authen)
	app.HandlerFunc(http.MethodDelete, version, "/products/{product_id}", api.delete, authen)
}
